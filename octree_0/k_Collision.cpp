...
void k_Collision::AddStaticObject(k_Object2D* pObj)
{
...
void k_Collision::AddDynamicObject(k_Object2D* pObj)
{
    k_Node2D* pFindNode = FindNodeToGo(QT.m_pRootNode, pObj);
    if (pFindNode != nullptr)
    {
...
std::vector<k_Object2D*> k_Collision::COL(k_Object2D* pObj)
{
...
void k_Collision::GCO(k_Node2D* pNode, k_Object2D* pObj, std::vector<k_Object2D*>& list) 
{
    if (pNode == nullptr) return;
