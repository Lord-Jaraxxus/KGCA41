...
bool K_Window::K_CoreInit()
{
    return false; 
}

bool K_Window::K_CoreFrame()
{
    return false;
}

bool K_Window::K_CoreRender()
{
    return false;
}

bool K_Window::K_CoreRelease()
{
    return false;
}
...
bool K_Window::Run()
{
    if(Init() == false) return false; // 이 Init은 밑에 샘플껏이 돌게될껐이다?
    //K_Window::Init();
